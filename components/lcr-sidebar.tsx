...
export function LCRSidebar({ activePage, onNavigate, isOpen = false, onClose }: LCRSidebarProps) {
        ...
        <div className="px-5 py-5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground leading-tight">LCR</div>
            </div>
          </div>
          {onClose && (
            <button
